Public Class Matriks_Calculator
    ...
    Private Sub ButtonProses_Click(sender As Object, e As EventArgs) Handles ButtonProses.Click
        Try
            ...
            Dim barisMatriks1 As Integer = TextBoxMatriks1.Lines.Count
            Dim kolomMatriks1 As Integer = TextBoxMatriks1.Lines.ElementAt(0).Split(" ").Length
            Dim barisMatriks2 As Integer = TextBoxMatriks1.Lines.Count
            Dim kolomMatriks2 As Integer = TextBoxMatriks1.Lines.ElementAt(0).Split(" ").Length
        ...
        Catch ex As Exception
            MsgBox("Maaf, yang Anda Masukkan bukan Angka")
        End Try
    End Sub
        ...
        If (Me.cekKolom) Then
            For baris As Integer = 0 To baris1 - 1
                For kolom As Integer = 0 To kolom1 - 1
                    nilai1(baris, kolom) = TextBoxMatriks1.Lines.ElementAt(baris).Split(" ").ElementAt(kolom)
                    nilai2(baris, kolom) = TextBoxMatriks2.Lines.ElementAt(baris).Split(" ").ElementAt(kolom)
                Next
            Next
        End If
    End Sub
    ...
    Private Sub cek(ByVal baris1 As Integer, baris2 As Integer, kolom1 As Integer, kolom2 As Integer)
        ...
        For baris = 0 To baris1 - 2
            If (TextBoxMatriks1.Lines.ElementAt(baris).Split(" ").Length <> TextBoxMatriks1.Lines.ElementAt(baris + 1).Split(" ").Length) Then
                tmp = False
            End If
        Next
        For baris = 0 To baris2 - 2
            If (TextBoxMatriks2.Lines.ElementAt(baris).Split(" ").Length <> TextBoxMatriks2.Lines.ElementAt(baris + 1).Split(" ").Length) Then
                tmp = False
            End If
        Next
        If (tmp = False) Then
            Me.cekKolom = False
            Convert.ToInt32(TextBoxMatriks1.Text)
            Convert.ToInt32(TextBoxMatriks2.Text)
            MsgBox("Matriks Tidak Valid")
        ElseIf (baris1 = baris2 And kolom1 = kolom2) Then
            Me.cekKolom = True
        Else
            Me.cekKolom = False
            MsgBox("Maaf, Baris dan Kolom Semua Matriks Harus Sama")
        End If
    End Sub
        ...
        If (Me.cekKolom) Then
            Select Case ComboBoxOperasi.Text
                ...
                Case "Pengurangan"
                    ...
                    Next
                Case Else
                    MsgBox("Maaf, Anda Belum Memilih Operasi")
            End Select
            TextBoxHasil.Text = hasil
        End If
    End Sub

    Private Sub TextBoxMatriks1_TextChanged(sender As Object, e As EventArgs) Handles TextBoxMatriks1.TextChanged
